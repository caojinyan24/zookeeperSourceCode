...
public class VerGen {
    private static final String PACKAGE_NAME = "apache.zookeeper.version";
    private static final String TYPE_NAME = "Info";

    static void printUsage() {
        System.out.print("Usage:\tjava  -cp <classpath> apache.zookeeper."
    ...
    public static void generateFile(File outputDir, Version version, int rev, String buildDate)
    {
        ...
        try {
            ...
            w.write("// Do not edit!\n// File generated by apache.zookeeper"
                    + ".version.util.VerGen.\n");
            w.write("/**\n");
    ...
    /**
     * Emits a apache.zookeeper.version.Info interface file with version and
     ...
     * Usage: java apache.zookeeper.version.util.VerGen maj.min.micro[-qualifier]
     * rev buildDate
     *
     * @param args
     *            <ul>
