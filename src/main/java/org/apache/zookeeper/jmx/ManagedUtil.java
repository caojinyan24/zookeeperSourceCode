...
public class ManagedUtil {
    ...
    private static final boolean isLog4jJmxEnabled() {
        ...
        try {
            Class.forName("apache.log4j.spi.LoggerRepository");
    ...
    public static void registerLog4jMBeans() throws JMException {
        if (isLog4jJmxEnabled()) {
            ...
            try {
                ...
                // apache.log4j.jmx.HierarchyDynamicMBean hdm = new apache.log4j.jmx.HierarchyDynamicMBean();
                Object hdm = Class.forName("apache.log4j.jmx.HierarchyDynamicMBean").newInstance();

                ObjectName mbo = new ObjectName("log4j:hiearchy=default");
                mbs.registerMBean(hdm, mbo);

                // Add the root logger to the Hierarchy MBean
                // apache.log4j.Logger rootLogger =
                // apache.log4j.Logger.getRootLogger();
                Object rootLogger = Class.forName("apache.log4j.Logger")
                ...
                // apache.log4j.spi.LoggerRepository r =
                // apache.log4j.LogManager.getLoggerRepository();
                Object r = Class.forName("apache.log4j.LogManager")
